                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +021 666 6 666</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> info@kahmipreneur.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-9">
                     ...
                     <?php if($customer_id != NULL){?>
                      ...
                      <?php  }else{?>
                        ...
                        <?php } ?>
                              <li><a href="{{URL::to('/')}}" class="active">Contact</a></li>
                                    </ul>
                                 <li class="dropdown"><a href="https://kahmipreneur.com/forum/">Forum</a>   
                                </li> 
                            </ul>
                        </div>
                    </div>
 ...
 @yield('slider');
    ...
    <footer id="footer"><!--Footer-->
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2>KAHMIPRENEUR-COMMERCE</h2>
                            <p>E-Commerce yang menghubungkan para anggota kahmi di berbagai macam daerah untuk membeli dan menjual produk - produknya</p>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Persayaratan dan Ketentuan</a></li>
                    ...
                    <div class="col-sm-4">
                        <div class="address">
                            ...
                            <p>DISTRICT 8, SCBD AREA JAKARTA, INDONESIA.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2018 KAHMIPRENEUR Inc. All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Iqbal Buchori</a></span></p>
                </div>
            </div>
        </div>
    </div>
