                 ...
                 @foreach( $all_order_info as $v_order)
					  <tbody>
						...
						<td class="center">
							...
							<a class="btn btn-danger" href="{{URL::to('penjual/unactive-order/'.$v_order->order_status)}}">
                           ...
                           <!-- <a class="btn btn-success" href="{{URL::to('/active/'.$v_order->order_id)}}">
							...
							<a class="btn btn-info" href="{{URL::to('penjual/view-order/'.$v_order->order_id)}}">
								<i class="halflings-icon white edit"></i>  
							</a>
							<a class="btn btn-danger" href="{{URL::to('penjual/delete/'.$v_order->order_id)}}" id="delete">
